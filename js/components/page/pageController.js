(function(angular) {
	...
	// contentService: we'll be calling functions from there
	...
	angular.module('nameApp').controller('pageController', ['$scope', '$routeParams', 'contentService', '$sce', 'languageService', pageController]);

	function pageController($scope, $routeParams, pageService, $sce, languageService) {
